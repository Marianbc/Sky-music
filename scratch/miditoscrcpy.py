...
def midiPiano(note, length=.25):
    ...
    if length == 0:
        ...
        #A Maj ? : key = round((1/344)*((200*(note-44))+101))
        #C Maj: key = round((1/344)*((200*(note-47))+101))
        #F Maj: key = round((1/344)*((200*(note-52))+101))
        #G Maj ? : key = round((1/344)*((200*(note-53))+101))
        key = round((1/344)*((200*(note-49))+101))
        #print(key)
        if key < 6:
            #print(f'{key} , {1}')
            piano(key,1)
